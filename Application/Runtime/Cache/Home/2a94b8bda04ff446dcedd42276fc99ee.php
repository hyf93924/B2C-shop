...
<head>
	...
	<link rel="stylesheet" href="/tpshop/Public/css/base.css" type="text/css" />
	<link rel="stylesheet" href="/tpshop/Public/css/shop_common.css" type="text/css" />
	<link rel="stylesheet" href="/tpshop/Public/css/shop_header.css" type="text/css" />
        <link rel="stylesheet" href="/tpshop/Public/css/shop_home.css" type="text/css" />
        <script type="text/javascript" src="/tpshop/Public/js/jquery.js" ></script>
        <script type="text/javascript" src="/tpshop/Public/js/topNav.js" ></script>
        <script type="text/javascript" src="/tpshop/Public/js/focus.js" ></script>
        <script type="text/javascript" src="/tpshop/Public/js/shop_home_tab.js" ></script>
</head>
<body>
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo"><h1 class="logo"><a href="/"><img src="/tpshop/Public/images/logo.png" alt="ShopCZ" /></a><span>ShopCZ</span></h1></div>
				...
				<div id="shop_hd_menu_all_category_hd" class="shop_hd_menu_all_category_hd">
					<ul class="shop_hd_menu_all_category_hd_menu clearfix">
						...
						<?php if(is_array($cats)): $k = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if($k < 9): ?><li id="cat_1" class="">
							<h3><a href="/tpshop/index.php/Home/Category/index/id/<?php echo ($vo["cat_id"]); ?>" title="男女服装"><?php echo ($vo["cat_name"]); ?></a></h3>
							<div id="cat_1_menu" class="cat_menu clearfix" style="">
								<?php if(is_array($vo["child"])): $i = 0; $__LIST__ = $vo["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><dl class="clearfix">
									<dt><a href="/tpshop/index.php/Home/Category/index/id/<?php echo ($vo1["cat_id"]); ?>"><?php echo ($vo1["cat_name"]); ?></a></dt>
									<dd>
										<?php if(is_array($vo1["child"])): $i = 0; $__LIST__ = $vo1["child"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($i % 2 );++$i;?><a href="/tpshop/index.php/Home/Category/index/id/<?php echo ($vo2["cat_id"]); ?>"><?php echo ($vo2["cat_name"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
									</dd>
	...
	<div class="shop_bd clearfix">
            ...
            <div class="shop_bd_top clearfix">
                ...
                <div class="shop_bd_top_center">
                    ...
                    <div class="xifan_sub_box">
                      ...
                      <div id="xifan_bd1lfimg">
                        <div>
                          <dl class=""></dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/tpshop/Public/images/e2dfe57add8fff66ed0964b1effd39b9.jpg" alt="2011城市主题公园亲子游"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011城市主题公园亲子游</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/tpshop/Public/images/e50b5d398e3b890f08e14defbc71a94d.jpg" alt="潜入城市周边清幽之地"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">潜入城市周边清幽之地</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/tpshop/Public/images/196b173f15685a2019ab3396cd1851a4.jpg" alt="盘点中国最美雪山"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">盘点中国最美雪山</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/tpshop/Public/images/e81345cbc3d8a7e11f9a0e09df68221d.jpg" alt="2011西安世园会攻略"></a></dt>
                            <dd><h2><a href="http://www.zztuku.com" target="_blank">2011西安世园会攻略</a></h2></dd>
                          </dl>
                          <dl class="">
                            <dt><a href="http://www.zztuku.com" title="" target="_blank"><img src="/tpshop/Public/images/65662b58848da87812ba371c7ff6c1ad.jpg" alt="五月乐享懒人天堂塞班岛"></a></dt>
                    ...
                    <!-- 图片切换  end --> 
                    <div class="clear"></div>
                    <div class="shop_bd_top_center_hot"><img src="/tpshop/Public/images/index.guanggao.png" /></div>
                </div>
            ...
            <ul>
            	<?php if(is_array($bestGoods)): $i = 0; $__LIST__ = $bestGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <dl>
                        <dt><a href="/tpshop/index.php/Home/Goods/index/id/<?php echo ($vo["goods_id"]); ?>">
                        <img src="<?php echo ($vo["goods_img"]); ?>" width="160" height="120" /></a></dt>
                        <dd><a href="/tpshop/index.php/Home/Goods/index/id/<?php echo ($vo["goods_id"]); ?>"><?php echo ($vo["goods_name"]); ?></a></dd>
                        ...
                        <div id="tuijian_content_2" class="tuijian_shangpin">
                            <ul>
                                <li>
                                    <dl>
                                        <dt><a href=""><img src="/tpshop/Public/images/365_7d5e08127b8d6799209674ecffbfc624.jpg_small.jpg" /></a></dt>
                ...
                <!-- 首发 -->
                <div class="shop_bd_shoufa"><img src="/tpshop/Public/images/shoufa.jpg" /></div>
                <!-- 首发 End -->
            ...
            <div class="shop_bd_home_block clearfix">
                ...
                <div class="shop_bd_home_block_left">
                    ...
                    <div class="shop_bd_home_block_left_pic">
                        <a href=""><img src="/tpshop/Public/images/web-1-13_53bfbfc958cb55a435545033bd075bf3.png"/></a>
                    </div>
                </div>
                <!-- 左边 End -->
                ...
                <div class="shop_bd_home_block_center">
                    ...
                    <div class="tabs-panel">
                        <ul>
                            <li>
                                <dl>
                                    <dt><a href=""><img src="/tpshop/Public/images/04fb225ea46bd1346f330400eedb7ef2.jpg_small.jpg" /></a></dt>
                ...
                <div class="shop_bd_home_block_right">
                    ...
                    <ol class="saletop-list">
                        <li class="top clearfix">
                            <dl>
                                ...
                                <dd class="nokey">1</dd>
                                <dd class="goods-pic">
                                    <a href=""><span class="thumb size60"><img src="/tpshop/Public/images/3f81874d594894d19150843c42fb1f8e.jpg_small.jpg" /></span></a>
                                </dd>
                    ...
                    <div class="saletop-list_adv_pic"><a href=""><img src="/tpshop/Public/images/web-3-38_ff9bd2d724f7138cec1b1937000f4feb.jpg" /></a></div>
                </div>
                <!-- 右边商品排行 -->
                ...
                <div class="shop_bd_home_block_bottom">
                    <ul class="">
                        <li><a href=""><img src="/tpshop/Public/images/354b80528d2fbeefbab33c563532517e.gif" /></a></li>
                        <li><a href=""><img src="/tpshop/Public/images/1d2dfbead590510046a6522551db8139.gif" /></a></li>
                        <li><a href=""><img src="/tpshop/Public/images/26247430b09daa1b441b46008bfb6e6e.gif" /></a></li>
                        <li><a href=""><img src="/tpshop/Public/images/a0ac8c6d2d3dc1470d5876923182a8e2.gif" /></a></li>
                        <li><a href=""><img src="/tpshop/Public/images/9c5dee77a6ecdafd9e152fed8c6a4e90.gif" /></a></li>
                        <li><a href=""><img src="/tpshop/Public/images/b175883eba95e793affb1b1ebbbf85a5.gif" /></a></li>
                        <li><a href=""><img src="/tpshop/Public/images/6e61a1c953e5bc8c5f1ffdac36862245.gif" /></a></li>
                        <li><a href=""><img src="/tpshop/Public/images/209abd835cd2ce2208f2dc42ba10efb4.gif" /></a></li>
                    </ul>
                </div>
                <!-- 品牌展示 End -->

...
<head>
	...
	<link rel="stylesheet" href="/tpshop/Public/css/shop_list.css" type="text/css" />
    <link rel="stylesheet" href="/tpshop/Public/css/shop_goods.css" type="text/css" />
    ...
    <script type="text/javascript" src="/tpshop/Public/js/shop_goods.js" ></script>
</head>
<body>
	...
	<div class="shop_goods_bd clear">
		...
		<div class="shop_goods_show">
			<div class="shop_goods_show_left">
				<!-- 京东商品展示 -->
				<link rel="stylesheet" href="/tpshop/Public/css/shop_goodPic.css" type="text/css" />
				<script type="text/javascript" src="/tpshop/Public/js/shop_goodPic_base.js"></script>
				<script type="text/javascript" src="/tpshop/Public/js/lib.js"></script>
				<script type="text/javascript" src="/tpshop/Public/js/163css.js"></script>
				<div id="preview">
					<div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="/tpshop<?php echo ($goods["goods_img"]); ?>" jqimg="/tpshop/Public/images/img04.jpg" width="350">
						</div>
						<div id="spec-n5">
							<div class=control id="spec-left">
								<img src="/tpshop/Public/images/left.gif" />
							</div>
							<div id="spec-list">
								<ul class="list-h">
									<li><img src="/tpshop/Public/images/img01.jpg"> </li>
									<li><img src="/tpshop/Public/images/img02.jpg"> </li>
									<li><img src="/tpshop/Public/images/img03.jpg"> </li>
									<li><img src="/tpshop/Public/images/img04.jpg"> </li>
									<li><img src="/tpshop/Public/images/img01.jpg"> </li>
									<li><img src="/tpshop/Public/images/img02.jpg"> </li>
									<li><img src="/tpshop/Public/images/img03.jpg"> </li>
									<li><img src="/tpshop/Public/images/img04.jpg"> </li>
							...
							<div class=control id="spec-right">
								<img src="/tpshop/Public/images/right.gif" />
							</div>
				...
				<div class="contents clearfix">
					<ul class="clearfix">
						...
						<li class="clearfix">
							...
							<div class="goods_pic"><span class="goods_price">¥ 279.00 </span><a href=""><img src="/tpshop/Public/images/89a6d6466b00ae32d3c826b9ec639084.jpg_small.jpg" /></a></div>
		...
		<!-- 商品详情 -->
		<script type="text/javascript" src="/tpshop/Public/js/shop_goods_tab.js"></script>

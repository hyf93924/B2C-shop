...
<head>
    ...
    <script type="text/javascript" src="/tpshop/Public/js/shop_list.js" ></script>
</head>
<body>
	...
	<div class="shop_hd_breadcrumb">
		...
		<span>
			<a href="">首页</a>&nbsp;›&nbsp;
			<?php if(is_array($parentCats)): $i = 0; $__LIST__ = $parentCats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/tpshop/index.php/Home/Category/index/id/<?php echo ($vo["cat_id"]); ?>">
		...
		<div class="shop_bd_list_right clearfix">
			...
			<div class="shop_bd_list_content clearfix">
				<ul>
					<li>
						<dl>
							<dt><a href=""><img src="/tpshop/Public/images/21151da3bdefc6d9a7120c991fe59800.jpg_small.jpg" /></a></dt>

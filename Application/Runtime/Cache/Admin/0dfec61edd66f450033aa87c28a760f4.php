...
<form method="post" action="" name='theForm'>
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <tr>
      <td colspan="2" align="right"><img src="/tpshop/index.php/Admin/Login/code" alt="CAPTCHA" border="1" onclick= this.src="/tpshop/index.php/Admin/Login/code/"+Math.random() style="cursor: pointer;" title="看不清？点击更换另一个验证码。" />
      </td>
      </tr>

...
<h1>
<span class="action-span"><a href="/tpshop/index.php/Admin/Type/add">新建商品类型</a></span>
	...
	<table width="100%" cellpadding="3" cellspacing="1" id="listTable">
		<tbody>
			...
			<?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td align="center">
				  <a href="/tpshop/index.php/Admin/Attribute/index/id/<?php echo ($vo["type_id"]); ?>" title="属性列表">属性列表</a> |
				  <a href="/tpshop/index.php/Admin/Type/edit/id/<?php echo ($vo["type_id"]); ?>" title="编辑">编辑</a> |
				  <a href="/tpshop/index.php/Admin/Type/delete/id/<?php echo ($vo["type_id"]); ?>" onclick="javascript:return confirm('删除商品类型将会清除该类型下的所有属性。\n您确定要删除选定的商品类型吗？')" title="移除">移除</a>
				</td>

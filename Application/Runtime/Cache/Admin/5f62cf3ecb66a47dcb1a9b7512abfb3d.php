			...
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  ...
						  <li class="menu-item"><a href="/tpshop/index.php/Admin/Category/index" target="main-frame">商品分类</a></li>
						  <li class="menu-item"><a href="/tpshop/index.php/Admin/Brand/index" target="main-frame">商品品牌</a></li>
						  <li class="menu-item"><a href="/tpshop/index.php/Admin/Type/index" target="main-frame">商品类型</a></li>				
						  <li class="menu-item"><a href="/tpshop/index.php/Admin/Goods/add" target="main-frame">添加新商品</a></li>
						  <li class="menu-item"><a href="/tpshop/index.php/Admin/Goods/index" target="main-frame">商品列表</a></li>
					</ul>
				</li>
